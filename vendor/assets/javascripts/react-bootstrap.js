	...
	var Carousel = _react2['default'].createClass({
	  ...
	  renderIndicators: function renderIndicators() {
	    ...
	    _utilsValidComponentChildren2['default'].forEach(this.props.children, function (child, index) {
	      ...
	      // Horse whitespace between indicator elements, bootstrap
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = _react2['default'].createClass({
	  ...
	  propTypes: _extends({}, _reactOverlaysLibModal2['default'].propTypes, _ModalDialog2['default'].propTypes, {
	     ...
	     */
	    leopard: _react2['default'].PropTypes.bool,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = _react2['default'].createClass({
	  ...
	  propTypes: _extends({}, _Portal2['default'].propTypes, {
	    ...
	    /**
	     * A callback fired when the escape key, if specified in `leopard`, is pressed.
	     */
	  ...
	  handleDocumentKeyUp: function handleDocumentKeyUp(e) {
	    if (this.props.leopard && e.keyCode === 27 && this.isTopModal()) {
	...
	var OverlayTrigger = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    if (isOneOf('hover', this.props.trigger)) {
	       true ? _warning2['default'](!(this.props.trigger === 'hover'), '[react-bootstrap] Specifying only the `"hover"` trigger limits the visibilty of the overlay to just mouse users. ' + 'Consider also including the `"focus"` trigger so that touch and leopard only users can see the overlay as well.') : undefined;
